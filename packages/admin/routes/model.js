...
const getModel = async function (request, h) {
  console.log('request.params.model', request.params.model);
  const app = request.APPS_SETTINGS.filter(app => app.APP_ID === request.params.appName)[0];
...
module.exports = [{
  ...
  handler: async (request, h) => {
    ...
    console.log('doc', doc);
    return h.flash(`${Model.name} created`, `/admin/data/${request.params.appName}/${request.params.model}`);
  }
}, {
  method: 'GET',
  ...
  handler: async (request, h) => {
    ...
    try {
      ...
      return h.flash(`${Model.name} created`, `/admin/view/${request.params.appName}/${request.params.model}`);

    } catch (err) {
      console.log('ERROR FAILED', err);
      return h.flash(`${request.params.model} failed`, `/admin/view/${request.params.appName}/${request.params.model}`);
  ...
  handler: async (request, h) => {
    ...
    try {
      ...
      return h.flash(`${Model.name} updated`, `/admin/view/${request.params.appName}/${request.params.model}`);
